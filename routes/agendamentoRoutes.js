...
router.get('/', async (req, res) => {
  try {
    const agendamentos = await Agendamento.find()
      .populate('pacienteId', 'nome_completo') // Popula os detalhes do paciente
      .populate('dentistaId', 'nome')          // Popula os detalhes do dentista
      .populate('procedimentoId', 'nome cor'); // Popula os detalhes do procedimento
